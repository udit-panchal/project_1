                ...
                <div className="container px-5 py-8 md:py-16 mx-auto">
                    ...
                    <div className="flex flex-wrap -m-4">
                        {project
                            ...
                            .filter((obj) =>
                                obj.college.includes(filterCollege)
                            )
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <div className="flex justify-center cursor-pointer">
                                                    <img
                                                        className=" rounded-2xl w-full h-80 p-2 hover:scale-110 transition-scale-110  duration-300 ease-in-out object-contain "
                                                        src={imageUrl}
                                                        alt="blog"
                                                    />
                                                </div>
